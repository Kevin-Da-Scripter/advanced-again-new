...
# Load environment variables from .env file (optional untuk lokal)
load_dotenv()
...
HUGGING_FACE_API = os.getenv("HUGGING_FACE_API_KEY")
 
# Discord Bot's Name
NAME = "ReflectionAI" # Change it to what you want to name the AI Bot | The AI bot will use the name for conversations and chats 
# Server Name
server_name = "✖　ⅼ　𝑴𝒊𝒅𝒍𝒖𝒏𝒂𝒓𝒊𝒔 𝑪𝒐𝒎𝒎𝒖𝒏𝒊𝒕𝒚 　‹" # Replace with your server name
# Creator Name
creator = "Carl (thecoolestcarlever)" # You can edit it to your name.
...
# Set this value using the SERPAPI_API_KEY environment variable on Railway.
SERPAPI_API_KEY = os.getenv("SERPAPI_API_KEY")

# Model Configuration
gemini_model = "Flash-25" # Options (Flash-25: Gemini 2.5 Flash | Pro: Gemini 1.5 Pro | Flash-8B: Gemini 1.5 Flash 8B | Pro-Latest: Gemini 1.5 Pro Latest | Flash-Latest: Gemini 1.5 Flash Latest | Exp-1206: Gemini Experimental 1206)
...
# Perbaikan: Memastikan Flash-25 menunjuk ke gemini-2.5-flash
elif gemini_model.lower() in ["flash-25", "flash-2"]:
    preview_model_name = "Gemini 2.5 Flash"
    ...
    model_name = "gemini-2.5-flash" # Diperbarui ke 2.5 Flash
...
# Gemini Model Mapping (v1-compatible)
GEMINI_MODEL_MAP = {
    # Diperbarui untuk menunjuk ke 2.5 Flash
    "Flash": "models/gemini-2.5-flash", 
    "Pro": "models/gemini-2.5-pro",
    "Flash-8B": "models/gemini-2.0-flash-lite",
    "Flash-002": "models/gemini-2.0-flash",
    "Pro-002": "models/gemini-2.0-pro-exp",
    "Flash-Latest": "models/gemini-2.5-flash",
    "Pro-Latest": "models/gemini-2.5-pro",
    "Exp-1114": "models/gemini-exp-1206",
